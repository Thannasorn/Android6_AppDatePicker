package com.thannasorn.appdatepicker;
...
public class MainActivity extends AppCompatActivity implements DatePicker.OnDateChangedListener, View.OnClickListener {
    ...
    public void onClick(View view) {
        String dateStr = "";
        dateStr = datePicker.getDayOfMonth() + "/" + datePicker.getMonth() + "/" + datePicker.getYear();
        Toast.makeText(this,"Your set date : " + dateStr, Toast.LENGTH_SHORT).show();
